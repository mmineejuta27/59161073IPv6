      ...
      <section class="hero is-info">
        <div class="hero-body">
          ...
          <div className="Container ">
            <div className="section" >
              ...
              <div className='columns is-mobile '>
                ...
                <div className='column'>
                  ...
                  <button className='button is-success is-rounded is-fullwidth' onClick={this.handleClick} onClick={this._Calculator}>Answer</button>
                  <br />
            ...
            <div class="column">
              <table class="table is-fullwidth is-info">
                <thead>
                  <tr>
